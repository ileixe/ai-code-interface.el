...
An Emacs interface for AI-assisted software development, designed to integrate seamlessly with your coding workflow. The purpose is to provide a uniform interface and experience for different AI backend.
...
`ai-code-interface` is a comprehensive Emacs package that connects your development environment to various AI coding assistants. It provides a rich set of interactive commands to facilitate a wide range of software engineering tasks, from writing and refactoring code to analyzing Git history and following agile methodologies like Test-Driven Development (TDD).

The core philosophy is to keep you in the editor, leveraging AI to augment your skills without disrupting your flow. It achieves this through deep integration with popular Emacs packages like Magit, Org-mode, Flycheck, and Helm.
...
1.  *Configuration*:
    ...
    *** Backend: `claude-code.el` (Default)
